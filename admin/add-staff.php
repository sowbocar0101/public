...
$verify_reg  = 0;
$query = sprintf('INSERT INTO %stbl_users (firstname, lastname, email, phone, pwd_raw, password_hash, account_create_date,referal_code,is_activated,account_type,photo_file,country_code,country_dial_code,country) VALUES'.
'("%s","%s","%s","%s","%s","%s","%s","%s","%d","%d","%s","%s","%s","%s")', 
    DB_TBL_PREFIX, 
