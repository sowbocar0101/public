...
$verify_reg  = 0;
$query = sprintf('UPDATE %stbl_users SET firstname = "%s", lastname = "%s", email = "%s", phone = "%s", pwd_raw = "%s", password_hash = "%s", referal_code = "%s",account_type = "%d",photo_file = "%s",country_code = "%s",country_dial_code = "%s",country = "%s" WHERE user_id = "%d"', 
    DB_TBL_PREFIX, 
